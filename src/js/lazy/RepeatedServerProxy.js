 ...
 * @protected
 */
Ext.define('Tualo.Pivotdata.RepeatedServerProxy', {
    extend: 'Ext.data.proxy.Proxy',
    alias: 'proxy.repeatedserver',
    ...
    setExtraParam: function(name, value) {
        console.log('setExtraParam',name, value);
    ...
    updateExtraParams: function(newExtraParams, oldExtraParams) {
        console.log('updateExtraParams',newExtraParams, oldExtraParams);
    ...
    processResponse: function(success, operation, request, response) {
        console.log('processResponse',success, operation, request, response);
        var me = this,
        ...
        if (success === true) {
            ...
            if (response.status === 204) {
                ...
                if (operation.getLimit() <= response.responseJson.data.length){
                    ...
                    console.log('operation getLimit',operation.getLimit()    );
                    console.log('operation.getLimit() <= response.responseJson.data.length',operation.getLimit(),response.responseJson.data.length);

                }
                console.log('me.extractResponseData(response)',);
                console.log('reader.read(me.extractResponseData(response)',reader,operation.getRecordCreator());     
                console.log('me',window.me = me);
    ...
    setException: function(operation, response) {
        console.log('setException',operation, response);
    ...
    applyEncoding: function(value) {
        console.log('applyEncoding',value);
    ...
    encodeSorters: function(sorters, preventArray) {
        console.log('encodeSorters',sorters, preventArray);
        var out = [],
    ...
    encodeFilters: function(filters) {
        console.log('encodeFilters',filters);
        var out = [],
    ...
    getParams: function(operation) {
        console.log('getParams',operation);
    ...
    encodeFields: function(fields) {
        console.log('encodeFields',fields);
        var out = [],
    ...
    doRequest: function(operation, callback, scope) {
        console.log('doRequest',operation, callback, scope);
        //<debug>
